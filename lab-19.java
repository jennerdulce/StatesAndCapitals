...
public class StatesAndCapitals
{
    ...
    public void testStatesAndCapitals() throws IOException
    {
        ...
        // TimeZones is an array
        Map<Object, Long> numberOfStatesByTimeZone = states.stream().collect(groupingBy(s -> s.getTimeZones().toString(), counting()));
        ...
        Map<Object, Long> numberOfStateCapitalsByTimeZone = states.stream().collect(groupingBy(s -> s.getCapital().getTimeZone(), counting()));
        ...
        List<String> allDistinctStateBirdsMinusMockingbirds = states.stream()
                .map(s -> s.getStateBird())
                .filter(b -> !b.contains("mockingbird"))
                .distinct()
                .collect(toList());
